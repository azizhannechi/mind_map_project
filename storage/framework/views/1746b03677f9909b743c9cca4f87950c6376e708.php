...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gojs/2.3.7/go.js"></script>
      <script> window.objectifsFromLaravel = <?php echo json_encode($objectifs, 15, 512) ?>
</script>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="bi bi-bullseye me-2"></i>GoalMind
            </a>
    ...
    <!-- Bootstrap JS -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script><?php /**PATH E:\mind_map_project\mind_map_project\resources\views/map.blade.php ENDPATH**/ ?>